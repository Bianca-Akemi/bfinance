...
class NavigationCubit extends Cubit<NavigationState> {
  NavigationCubit()
    : super(NavigationState(bottomNavItems: Routes.home.name, index: 0));

  void getNavBarItem(int index) {
    switch (index) {
      case 0:
        emit(NavigationState(bottomNavItems: Routes.home.name, index: 0));

      case 1:
        emit(
          NavigationState(bottomNavItems: Routes.transactions.name, index: 1),
        );
